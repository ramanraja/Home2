...
// Avoid hard coded WiFi backup credentials because we use WiFi manager to get them at any time
/////char  wifi_backup_ssid [MAX_TINY_STRING_LENGTH];       
////char  wifi_backup_passwd [MAX_TINY_STRING_LENGTH];    
