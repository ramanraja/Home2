...
new in this version:
 - introduced preprocessor switch #define MQTT_ENABLED for OTA server
 - implemented backup certificate server 
 - implemented backup firmware server
 - rationalized error codes for certificate download and OTA updates
*/
#include "main.h"
