...
void CommandHandler::send_data () { // TODO: take the status as an argument  
    ...
    snprintf (status_msg, MAX_MSG_LENGTH-1, "{\"D\":{\"S\":\"%s\",\"T\":%.1f,\"H\":%.1f,\"I\":%.1f,\"L\":%d,\"R\":%d,\"M\":%d}}",  
...
#define  NUM_COMMANDS    15  // excluding on and off commands
// NOTE: If you change the order of the following strings, you must change the switch cases also !
const char* commands[] = { "STA", "VER", "MAC", "GRO", "ORG", "HEA", "REB", "DEL", "UPD", "AUT", "MAN", "MOD", "BL1", "BL2", "DAT" };
